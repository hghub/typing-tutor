        ...
        >
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.target.style.transform = 'scale(1.05)'
                e.target.style.boxShadow = '0 25px 50px -12px rgba(245, 158, 11, 0.5)'
              }}
              onMouseLeave={(e) => {
                e.target.style.transform = 'scale(1)'
                e.target.style.boxShadow = '0 20px 25px -5px rgba(245, 158, 11, 0.3)'
              }}
            >
              💡 Suggest a Feature
            </button>
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div>
                <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 600, color: colors.textSecondary, marginBottom: '0.4rem' }}>
                  Your Name (optional)
                </label>
                <input
                  type="text"
              ...
              <button
                ...
                onClick={() => {
                  const typeLabel = feedbackType === 'suggestion' ? 'Feature Suggestion' : feedbackType === 'bug' ? 'Bug Report' : 'Other'
