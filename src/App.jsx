    ...
    <div style={{ minHeight: '100vh', background: colors.bg, transition: 'background 0.3s ease' }}>
      ...
      <ToolSEOFooter
        ...
        faqs={[
          ...
          { q: "What languages does Typely support?", a: "Typely has 4 built-in language packs: English, Urdu, Arabic, and Persian — each with curated passage sets. For Urdu, Arabic, and Persian, Phonetic Input lets you type in Roman characters which automatically convert to the correct script. You can also paste any custom text to practice typing in any language including French, Spanish, Hindi, and more." },
