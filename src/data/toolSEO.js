...
const TOOL_SEO = {
  'typing-tutor': {
    ...
    metaDesc: 'Free typing tutor with WPM test, 1v1 battles, XP system, Kids Mode, Urdu/Arabic phonetic input, per-key analysis & career readiness. No sign-up. 8 languages.',
