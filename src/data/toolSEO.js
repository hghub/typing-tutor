...
const TOOL_SEO = {
  'typing-tutor': {
    ...
    faqs: [
      ...
      { q: 'How long does it take to improve typing speed?', a: 'With 20–30 minutes of daily practice, most people improve by 10–15 WPM within 2–3 weeks. The key habit to develop is touch typing — never looking at the keyboard. Use Typely\'s per-key analysis to identify your weakest keys and drill those specifically.' },
      { q: 'Does Typely work for kids and beginners?', a: 'Yes. Kids Mode provides a simplified, encouraging interface with shorter words and a larger font. Beginner difficulty uses the most common short words and gives gentle feedback. Children as young as 6 can start with Kids Mode and progress naturally through difficulty levels.' },
      { q: 'What languages does Typely support?', a: 'Typely has 4 built-in language packs: English, Urdu, Arabic, and Persian — each with curated passage sets. For Urdu, Arabic, and Persian, Phonetic Input lets you type in Roman characters which automatically convert to the correct script. You can also use the Custom Passage feature to paste text in any language (French, Spanish, Hindi, etc.) and practice typing it.' },
      ...
      { q: 'What is the XP and Levels system?', a: 'Every completed typing session earns you XP (experience points) based on your WPM and accuracy. Accumulate enough XP to level up your profile. Maintain a daily Streak by completing at least one session per day. Your level and streak are saved in your browser and displayed on the dashboard.' },
      { q: 'What is Career Readiness mode?', a: 'Career Readiness mode uses professional vocabulary and realistic office-style passages — emails, reports, meeting notes. It\'s designed for job-seekers, office workers, and students who need to demonstrate fast, accurate typing in professional settings. Completing it builds both speed and workplace vocabulary.' },
      { q: 'What does per-key Typing Analysis show?', a: 'After each session, Typely shows a heatmap of every key you pressed, highlighting which keys had the most errors and slowest reaction time. This tells you exactly which fingers and keys to focus your practice on, making your improvement targeted and efficient.' },
      { q: 'Can I practise with my own custom text?', a: 'Yes. Select Custom Passage in the settings, paste any text you want, and Typely will use it as your typing passage. This is useful for practising specific documents, code snippets, emails, or any text relevant to your work.' },
      { q: 'What is Timer Mode?', a: 'Timer Mode adds a countdown clock (e.g. 1 min, 2 min, 5 min) to your session. You type as much as possible before time runs out, and Typely calculates your WPM and accuracy for the duration. This simulates real typing tests and builds performance under pressure.' },
      { q: 'How does the Virtual Keyboard work?', a: 'The on-screen Virtual Keyboard lights up each key as you type, with colour-coding to show correct finger placement. It\'s especially helpful for beginners learning hand positioning and for Urdu/Arabic learners who want to see which physical key maps to which character.' },
      { q: 'What difficulty levels are available?', a: 'Typely has 5 difficulty levels: Beginner, Easy, Medium, Hard, and Islamic. Beginner uses very common short words. Islamic difficulty features passages from Islamic texts, ideal for students of religious studies. Each level increases vocabulary complexity and passage length.' },
      { q: 'Is my typing data stored privately?', a: 'Yes. All data — your WPM history, XP, level, streaks, and settings — is stored only in your browser\'s localStorage. Nothing is sent to any server. Your data never leaves your device and is not accessible to anyone else.' },
  ...
  'rent-vs-buy-pakistan': {
    ...
    faqs: [
      { q: 'What does this rent vs buy calculator include?', a: 'It includes monthly rent, property price, down payment, mortgage markup, stay horizon, transfer costs, maintenance, property tax, home-price growth, rent growth, and the return you could earn by investing your down payment instead.' },
      { q: 'Why is stay horizon so important?', a: 'Buying usually becomes stronger over longer holding periods because the upfront friction of transfer fees, down payment lock-up, and maintenance gets spread across more years. Short horizons often favor renting.' },
      { q: 'Does this use official mortgage rates?', a: 'No. It uses adjustable planning assumptions. Markup and financing terms vary by bank, profile, and product. Always compare this tool\'s baseline against an actual sanction or indicative term sheet.' },
      { q: 'Can this tell me exactly which city will appreciate more?', a: 'No. Appreciation assumptions are scenario inputs, not guarantees. The tool helps you test whether your buy case remains strong even if appreciation is lower than expected.' },
      { q: 'Is this financial advice?', a: 'No. It is a structured comparison tool for planning. You should verify financing terms, transaction costs, and your risk tolerance before making a property decision.' },
    ],
  },
  'salary-offer-evaluator': {
    ...
    faqs: [
      { q: 'What does this salary offer evaluator include?', a: 'It includes gross monthly salary, annual bonus, commute cost, remote work flexibility, employer-paid benefits, provident fund support, relocation value, and an after-tax estimate using current salaried tax logic.' },
      { q: 'Does it replace an employment contract review?', a: 'No. It helps you compare the economics and practical quality of an offer. You should still review contract clauses, probation terms, leave policy, bonuses, notice period, and benefit wording separately.' },
      { q: 'Why compare city cost baselines?', a: 'Because a job that requires moving to a more expensive city can reduce your true saving power even when salary looks better. The city baseline helps translate salary into actual breathing room.' },
      { q: 'Can I compare the offer to my current role?', a: 'Yes. The tool includes a benchmark section for your current annual value and role quality scores so you can compare switch value more honestly.' },
      { q: 'Is this updated for the latest tax year?', a: 'It uses the current salaried tax logic configured in Rafiqy. Compensation decisions should still be verified against actual payroll treatment from the employer.' },
    ],
  },
  'freelance-tax-planner': {
    ...
    faqs: [
      { q: 'What does this freelance planner actually calculate?', a: 'It estimates monthly tax reserve, operating reserve, emergency-fund top-up, and a suggested owner pay figure after those reserves and your core business costs.' },
      { q: 'Is this an official tax filing tool?', a: 'No. It is a reserve-planning tool. Freelancers can be taxed differently depending on filing structure, business setup, documented expenses, and current law. Confirm your actual filing treatment separately.' },
      { q: 'Why separate tax reserve from operating reserve?', a: 'Because they solve different risks. Tax reserve protects you from year-end liability. Operating reserve protects you from delayed clients, slow months, and business shocks.' },
      { q: 'How many months of emergency runway should a freelancer target?', a: 'Six months is a good baseline for many independent workers. More volatile client mixes may justify nine to twelve months.' },
      { q: 'Can this help me decide whether I am paying myself too much?', a: 'Yes. The suggested owner pay output is specifically meant to show whether personal withdrawals are starving tax and reserve discipline.' },
    ],
  },
  'investment-allocation-planner': {
    ...
    faqs: [
      ...
      { q: 'Can this handle multi-goal family portfolios instead of just one clean objective?', a: 'Yes. The planner now includes a goal-structure layer so you can treat the corpus as a single-purpose plan or as a multi-goal family portfolio. Multi-goal capital usually needs more internal safety and clearer shortlisting discipline.' },
      ...
      { q: 'How often should I rebalance a portfolio like this?', a: 'A calm review every 6 to 12 months is a good baseline for many users, with earlier review after large contributions, large withdrawals, or meaningful life changes. Rebalance because the role of the money changed or the bucket weights drifted materially, not just because headlines got noisy.' },
  ...
  'car-powertrain-decision': {
    ...
    faqs: [
      { q: 'What does this EV vs hybrid calculator include?', a: 'It includes daily kilometres, city-driving ratio, petrol price, electricity tariff, purchase prices, charging availability, load shedding, fuel efficiency, maintenance assumptions, and resale factors over a five-year horizon.' },
      { q: 'Why does charging availability matter so much?', a: 'Because an EV can look cheap on paper but become operationally frustrating if home charging is weak or public charging is unreliable. The tool applies convenience and risk penalties for that reason.' },
      { q: 'Why can hybrid beat EV even when EV energy cost is lower?', a: 'Because upfront price, resale uncertainty, charging inconvenience, and outage reality can offset the cheaper running cost of EVs in some scenarios.' },
      { q: 'Does this use exact market prices for every car model?', a: 'No. It uses adjustable baseline assumptions. Change the purchase-price inputs to match the models you are actually considering.' },
      { q: 'How often should the base data be updated?', a: 'Fuel price, electricity tariff, and broad operating assumptions should be refreshed monthly. Resale assumptions should be revisited at least quarterly.' },
    ],
  },
  'solar-planner': {
    metaTitle: 'Solar Calculator | Solar System Size, Cost & Payback | Rafiqy',
    metaDesc: 'Estimate solar system size, install cost, monthly savings and payback using your bill, city, appliance load and current net billing assumptions. Built for Pakistan homes and tariffs.',
    heading: 'Solar Calculator — Estimate Solar System Size, Cost and Payback',
    paras: [
      'Rafiqy\'s Solar Calculator helps homeowners estimate solar system size, install cost, monthly savings and payback using their current electricity bill, location and appliance load. It is built for people searching for a solar calculator, solar system calculator, solar size calculator or solar payback calculator, with the assumptions tuned for Pakistan.',
      'The tool uses city-specific sun-hour assumptions, a visible derating factor, current installed-cost ranges, and current net billing assumptions so the recommendation is more realistic than a one-size-fits-all quote. Self-consumed electricity is valued differently from exported electricity, which matters much more after the move from older net metering logic to net billing.',
      'Use it to compare a full net-billing setup against a smaller self-consumption-focused system, understand whether battery storage is worth considering, and test common scenarios like a PKR 20,000 bill, a PKR 30,000 bill, or a home with daytime occupancy and AC load.',
      'The result is a planning estimate, not a contractor quote, but it gives you a strong benchmark for system sizing, cost conversations, payback expectations, and installer quote comparison. The page also explains the sizing formula, meter-fee assumptions, and the main factors that change your result.',
    ],
    faqs: [
      { q: 'How does this solar calculator work?', a: 'The calculator starts from either your electricity bill or appliance-based daily load, converts that into estimated daily kWh usage, divides by your city\'s peak sun hours, and applies a real-world derating factor of 0.80 for heat, dust, inverter and wiring losses. It then estimates monthly generation, self-consumption, exported units, monthly savings, cost range and payback.' },
      ...
      { q: 'What solar system size do I need in Pakistan?', a: 'Most homes with a PKR 15,000–25,000/month bill need a 5–7 kW on-grid system. The Solar Planner calculates your specific load using your bill and appliance usage, divides by your city peak sun hours, and applies a 0.80 derating factor for real-world efficiency losses.' },
      { q: 'How much does solar cost in Pakistan in 2026?', a: 'A fully installed on-grid system costs PKR 130,000–200,000 per kW in 2026. A 5 kW system costs PKR 6.5–10 lakh including panels, inverter, mounting, wiring, and installation. Battery is a separate add-on (LiFePO4 5 kWh: PKR 2.25–2.80 lakh).' },
      { q: 'What is net billing in Pakistan and how is it different from net metering?', a: 'NEPRA replaced net metering with net billing in December 2025. Under net billing, excess electricity you export to the grid is paid at a fixed PKR 11/unit — not at the retail rate. This means exporting surplus is far less valuable than self-consuming it. Right-sizing for self-consumption is now more important than ever.' },
      { q: 'Which cities in Pakistan have the best solar potential?', a: 'Quetta and Sukkur lead with 6.0 peak sun hours/day. Karachi, Hyderabad, and Multan average 5.5 hours. Lahore, Faisalabad, and Peshawar get 5.0 hours. Islamabad and Rawalpindi receive 4.8 hours. More sun hours means a smaller system covers the same load.' },
      { q: 'Do I need a battery with my solar system in Pakistan?', a: 'If you face 4+ hours of daily load-shedding, a battery is strongly recommended. A grid-tied inverter shuts down during outages. Under net billing, a battery also converts PKR 11/unit exported energy into PKR 45–70/unit self-use, improving your payback by 1–2 years for high-export households.' },
      { q: 'How long is the solar payback period in Pakistan in 2026?', a: 'For bills above PKR 25,000/month, payback is typically 3–5 years (Strongly Recommended). For PKR 15,000–25,000, expect 5–8 years (Recommended). For PKR 10,000–15,000, expect 8–12 years (Worth Considering). Below PKR 5,000/month, payback exceeds 12 years.' },
      { q: 'What changes the solar payback period the most?', a: 'The biggest factors are your monthly bill, how much of the solar power you use yourself during the day, your city sun hours, the installer\'s PKR-per-watt quote, whether net billing fees apply, and whether you add battery storage. A slightly smaller self-consumption-focused system can sometimes beat a larger export-heavy one.' },
      { q: 'What are the net billing meter fees in Pakistan?', a: 'Net billing requires a bi-directional solar AMI meter separate from your regular smart meter. Fees vary by DISCO: IESCO ~PKR 55,000, LESCO ~PKR 80–90,000 (fee doubled recently, private purchase banned), FESCO ~PKR 45,000, MEPCO/PESCO ~PKR 42,000, HESCO/QESCO ~PKR 40,000.' },
    ],
  },
}
