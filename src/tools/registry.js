...
export const TOOLS = [
  ...
  {
    id: 'cnic-validator',
    name: 'CNIC Validator & Decoder',
    nameUrdu: 'شناختی کارڈ ویلیڈیٹر',
    tagline: 'Validate and decode Pakistan CNIC, B-Form, NTN & STRN',
    taglineUrdu: 'شناختی کارڈ، بی فارم، این ٹی این اور ایس ٹی آر این کی تصدیق',
    description: 'Validate and decode Pakistan CNIC numbers — extract province, division, and gender from the number structure. Also validates B-Form, NTN, and STRN formats. Includes bulk validator for multiple CNICs.',
    icon: '🪪',
    path: '/tools/cnic-validator',
    color: '#0ea5e9',
    category: 'pakistan',
    region: 'pk',
    tags: ['cnic', 'nadra', 'id card', 'pakistan', 'ntn', 'strn', 'b-form', 'validator', 'identity'],
    related: ['ntn-checker', 'tax-calculator', 'salary-slip'],
    features: ['CNIC decode: province, division, gender', 'Auto-formats as XXXXX-YYYYYYY-Z while typing', 'Bulk validator — paste many CNICs at once', 'Also validates B-Form, NTN, and STRN formats'],
  },
  {
    id: 'loan-manager',
    name: 'Loan Manager',
  ...
  {
    id: 'ntn-checker',
    name: 'NTN / FBR Tax Reference',
    nameUrdu: 'این ٹی این / ایف بی آر ٹیکس حوالہ',
    tagline: 'NTN & STRN validator + WHT rates + FBR tax calendar',
    taglineUrdu: 'این ٹی این، ایس ٹی آر این ویلیڈیٹر + ود ہولڈنگ ٹیکس + ایف بی آر کیلنڈر',
    description: 'Validate NTN and STRN formats, decode CNIC to relevant FBR RTO, check filer vs non-filer withholding tax rates, key FBR deadlines, and a full glossary of Pakistan tax terms.',
    icon: '🏛️',
    path: '/tools/ntn-checker',
    color: '#0ea5e9',
    category: 'pakistan',
    region: 'pk',
    tags: ['ntn', 'strn', 'fbr', 'tax', 'filer', 'atl', 'withholding', 'pakistan', 'income tax', 'sales tax'],
    related: ['tax-calculator', 'salary-slip', 'cnic-validator'],
    features: ['NTN & STRN format validator with auto-formatting', 'CNIC → province + FBR RTO mapping', 'Filer vs non-filer WHT rate comparison table', 'Key FBR deadlines calendar + tax glossary'],
  },
  {
    id: 'tax-optimizer',
